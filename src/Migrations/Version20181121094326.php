 ...
 */
final class Version20181121094326 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE ticket ADD reservation_id INT NOT NULL, DROP birthday');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE ticket ADD birthday DATETIME NOT NULL, DROP reservation_id');
    }
}
